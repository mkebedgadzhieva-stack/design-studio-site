...
const SERVICES = [
  ...
  { id: "premium", title: "Premium", price: 65000, desc: "Максимум материалов + анимация", bullets: ["Логотип (3–5 концепций)", "Гайд 60+ стр.", "Печатные макеты", "Сопровождение запуска"] },
];
    ...
    <section className="relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 py-24 md:py-32">
        ...
        <p className="mt-6 text-gray-600 max-w-2xl">
          Кураторская дизайн-студия: айдентика, упаковка, презентации и сайт-визитка. Умный, ироничный тон — не для всех, а для своих.
        </p>
    ...
    <Section id="offer" title="Публичная оферта">
      <Card>
        <div className="prose max-w-none">
          ...
          <p>
            Настоящая оферта является официальным предложением [ИП «Название моей студии»]
            (далее — <strong>Исполнитель</strong>) заключить договор на оказание дизайн-услуг с любым
            дееспособным лицом (далее — <strong>Заказчик</strong>) на условиях, изложенных ниже.
          </p>

          <h2 className="mt-8 pt-4 border-t border-gray-200 first:mt-0 first:pt-0 first:border-0">1. Термины</h2>
          <div className="space-y-1">
            <p><strong>1.1. Сайт</strong> — [домен сайта].</p>
            <p><strong>1.2. Услуги</strong> — графический дизайн и брендинг: логотип, айдентика, бренд-гайд/брендбук, презентации, упаковка, шаблоны для соцсетей и иные носители по согласованию.</p>
            <p><strong>1.3. Бриф</strong> — задание/анкета, включая переписку в e-mail/Telegram.</p>
            <p><strong>1.4. Материалы Заказчика</strong> — тексты, изображения, данные, товарные знаки, референсы и иная информация, переданная Исполнителю.</p>
            <p><strong>1.5. Результат работ (РК)</strong> — макеты, исходники и иные файлы, созданные Исполнителем.</p>
            <p><strong>1.6. Раунд правок</strong> — набор правок, переданных одним сообщением/документом по одной версии РК.</p>
          </div>

          <h2 className="mt-8 pt-4 border-t border-gray-200">2. Предмет</h2>
          <div className="space-y-1">
            <p><strong>2.1.</strong> Исполнитель оказывает Услуги, Заказчик принимает и оплачивает их.</p>
            <p><strong>2.2.</strong> Состав работ, сроки и формат сдачи определяются выбранным пакетом на Сайте и/или подтверждаются сторонами в переписке.</p>
            <p><strong>2.3.</strong> Электронная переписка (e-mail/Telegram) признаётся простой электронной подписью сторон.</p>
          </div>

          <h2 className="mt-8 pt-4 border-t border-gray-200">3. Акцепт оферты</h2>
          <div className="space-y-1">
            <p><strong>3.1.</strong> Договор считается заключённым с момента:</p>
            <ul className="!mt-2">
            ...
            <p><strong>3.2.</strong> Акцепт означает согласие с настоящей офертой и Политикой конфиденциальности на Сайте.</p>
          </div>

          <h2 className="mt-8 pt-4 border-t border-gray-200">4. Стоимость и оплата</h2>
          <div className="space-y-1">
            <p><strong>4.1.</strong> Стоимость определяется по ценам на Сайте и/или согласованным в переписке.</p>
            <p><strong>4.2. График:</strong> <strong>50% предоплата</strong> перед стартом, <strong>50% — перед передачей финальных файлов</strong>.</p>
            <p><strong>4.3.</strong> В пакет входит указанное на Сайте число раундов правок. <strong>Каждый новый раунд правок сверх включённых — 2 000 ₽.</strong></p>
            <p><strong>4.4.</strong> Допработы вне объёма пакета (новые носители, допконцепции и пр.) — по отдельной смете/ставке, согласованной письменно.</p>
            <p><strong>4.5.</strong> Оплата — безналично: банковская карта/счёт/иные способы.</p>
          </div>

          <h2 className="mt-8 pt-4 border-t border-gray-200">5. Процесс и сроки</h2>
          <div className="space-y-1">
            <p><strong>5.1.</strong> Старт — после акцепта и получения предоплаты (и Брифа/Материалов).</p>
            <p><strong>5.2.</strong> Сроки этапов являются ориентировочными; корректируются пропорционально срокам предоставления Материалов/фидбэка.</p>
            <p><strong>5.3. Обратная связь: 2 рабочих дня.</strong> Заказчик обязуется давать обратную связь по отправленным версиям <strong>в течение двух рабочих дней</strong>. При отсутствии ответа <strong>Исполнитель вправе продолжать работы по плану/следующим этапам</strong>.</p>
            <p><strong>5.4.</strong> Существенные изменения исходного ТЗ считаются допработами и подлежат отдельному согласованию и оплате.</p>
            <p><strong>5.5.</strong> Промежуточные версии могут направляться с водяными знаками/пониженным качеством до финальной оплаты.</p>
          </div>

          <h2 className="mt-8 pt-4 border-t border-gray-200">6. Приёмка и передача РК</h2>
          <div className="space-y-1">
            <p><strong>6.1.</strong> Передача РК — в цифровом виде (ссылки/файлы: PDF, PNG/SVG, Figma/AI/PSD — согласно пакету).</p>
            <p><strong>6.2.</strong> После <strong>полной оплаты</strong> Исполнитель передаёт финальные файлы (без водяных знаков) и права по разд. 7.</p>
            <p><strong>6.3. Электронный акт и приёмка.</strong> По запросу Заказчика акт оформляется электронно: (i) через ЭДО (Диадок/СБИС/Контур/1С-ЭДО/иное) с КЭП, (ii) через DocuSign/PandaDoc/аналог, либо (iii) простая электронная подпись — сообщением в e-mail/Telegram «Акт принят»/«Работы приняты без замечаний». <strong>Оплата финального платежа также считается принятием работ.</strong> Если в течение <strong>2 рабочих дней</strong> замечаний не поступило, Исполнитель вправе продолжать работы по плану; итоговое подтверждение приёмки оформляется любым из указанных способов.</p>
          </div>

          <h2 className="mt-8 pt-4 border-t border-gray-200">7. Права и сторонние лицензии</h2>
          <div className="space-y-1">
            <p><strong>7.1.</strong> Исключительные права на РК переходят Заказчику <strong>после полной оплаты</strong>, на территории всего мира, на срок действия авторских прав.</p>
            <p><strong>7.2.</strong> Права на объекты третьих лиц (шрифты, стоки, плагины и т.п.) не переходят и регулируются их лицензиями. Исполнитель помогает подобрать/оформить лицензии; стоимость согласуется заранее. Заказчик обязуется соблюдать условия соответствующих лицензий.</p>
            <p><strong>7.3. Портфолио / NDA.</strong> Исполнитель вправе показывать проект в портфолио и соцсетях. <strong>Если публикация нежелательна, Заказчик направляет короткое уведомление или стороны подписывают NDA — публикации не будет.</strong></p>
          </div>

          <h2 className="mt-8 pt-4 border-t border-gray-200">8. Обязанности сторон</h2>
          <div className="space-y-1">
            <p><strong>8.1. Заказчик:</strong></p>
            <ul className="!mt-2">
            ...
            <p><strong>8.2. Исполнитель:</strong></p>
            <ul className="!mt-2">
            ...
            <p><strong>8.3.</strong> Исполнитель не отвечает за задержки, вызванные несвоевременным предоставлением Заказчиком Материалов/фидбэка.</p>
          </div>
